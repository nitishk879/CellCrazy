    ...
    <section class="product-details-area mtb-60px">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6 col-md-12">
                    <div class="product-details-content" id="brandNew">
                        ...
                        <p class="reference text-success">{{ $item->type->name }}</p>
                        ...
                        <div class="pro-details-policy">
                            <div class="features mb-2">
                                <span href="" class="badge badge-theme"><i class="fa fa-truck text-white-50"></i> Free Delivery</span>
                                <span href="" class="badge badge-theme"><i class="fa fa-unlock text-white-50"></i> Unlocked</span>
                                <span href="" class="badge badge-theme"><i class="fa fa-certificate text-white-50"></i> Certified Device</span>
                                <span href="" class="badge badge-theme"><i class="fa fa-calendar text-white-50"></i> 14 days return</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6 p-3">
                    <div class="media bg-light">
                        <i class="fas fa-check-circle fa-2x text-primary align-self-center mr-3"></i>
                        <div class="media-body">
                            <h5 class="font-weight-bold text-info">12 Months Warranty! </h5>
                ...
                <div class="col-md-6 p-3">
                    <div class="media bg-light">
                        <i class="fas fa-box-open fa-2x text-primary align-self-center mr-3"></i>
                        <div class="media-body">
                            <p class="p-2">
